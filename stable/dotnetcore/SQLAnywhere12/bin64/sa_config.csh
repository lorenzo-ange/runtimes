...
setenv SQLANY12 "/home/photosi/source/sqlany"

[ -r "$HOME/.sqlanywhere12/sample_env64.sh" ] && source "$HOME/.sqlanywhere12/sample_env64.sh" 
if ( ! $?SQLANYSAMP12 ) then
    setenv SQLANYSAMP12 "/home/photosi/source/sqlany/samples"
endif

# the following lines add SA binaries to your path.
if ( $?PATH ) then
    setenv PATH "$SQLANY12/bin64:$SQLANY12/bin32:$PATH"
else
    setenv PATH "$SQLANY12/bin64:$SQLANY12/bin32"
endif
